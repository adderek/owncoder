...
def _apply_env_overrides(config: Config) -> None:
    env_map = {
        ...
        "AGENT_VERIFY_ENABLED": ("verify", "enabled"),
        "AGENT_VERIFY_COMMAND": ("verify", "command"),
        "AGENT_VERIFY_TIMEOUT": ("verify", "timeout_s"),
        ...
        "AGENT_EXPLORE_ENABLED": ("explore", "enabled"),
        "AGENT_EXPLORE_MODEL": ("explore", "model"),
        "AGENT_EXPLORE_MAX_ITERATIONS": ("explore", "max_iterations"),

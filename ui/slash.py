...
_SLASH_COMMANDS: list[tuple[str, list[str], str, bool]] = [
    ...
    ("/security", ["/sec", "/audit"], "security: scan|diff|triage|selfaudit|report [path] | baseline [...] | airgap [...] | integrity [seal|check] | weights [pin|verify|list] | sbom [path] | taint [path] | verify [<i>|run] | full [path] | review [path]", True),
